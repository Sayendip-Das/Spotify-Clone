    ...
    >
      <div className="flex gap-8">
        <div className="flex flex-col gap-4">
          <p className="text-2xl">Upload Song</p>
          <input
      ...
      <div className="flex flex-col gap-2.5">
        ...
        <input
          ...
          type="text"
          className="bg-transparent outline-green-600 border-2 p-2.5 w-[max(40vw,500px)] border-gray-600"
      ...
      <button
        type="submit"
        className="text-base bg-black text-white py-2.5 px-14 w-[200px] cursor-pointer"
      >
        ADD
      </button>
    </form>
